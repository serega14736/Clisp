...
;;; (1 2 3 (((4 5 6) (1 2 1)))) 1 'a) -> (A 2 3 (((4 5 6) (A 2 A))))

(defun replacemant (lst w r)
  (mapcar #'(lambda (x)
               (cond ((equal x w) r)
                     ((listp x) (replacemant x w r))
                     (t x))) lst))

;;; Test 1
(write-line "Задача 3 Test 1")
(princ " >> (1 2 3 (((4 5 6) (1 2 1)))) 1 'a) ")
(print(replacemant `(1 2 3 (((1 2 3) (1 2 3)))) 1 'a))
(write-line "")
(write-line "")

;;; Test 2
(write-line "Задача 3 Test 2")
(princ " >> (125 25 25 0 32 25 91) 25 'b) ")
(print(replacemant `(125 25 25 0 32 25 91) 25 'b))
(write-line "")
(write-line "")
