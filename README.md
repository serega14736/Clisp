...
Еще примеры сайтов на Haskell — [hpaste.org](https://hpaste.org) и блог [lymar.ru](https://lymar.ru). Если вы предпочитаете работать с фреймворками, то будете рады узнать, что для Haskell написано довольно много готовых веб-фрейморков.
